              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="font-serif text-xl font-bold text-primary">
                    {selectedClient.displayName || selectedClient.name || 'Cliente'}
                  </h2>
                  <p className="text-sm text-gray-400">{selectedClient.uid}</p>
                </div>
              </div>
              <button onClick={() => setSelectedClient(null)} className="p-2 hover:bg-gray-100 rounded-full text-gray-500 hover:text-gray-700 transition-colors">
                <X size={24} />
              </button>
            </div>
